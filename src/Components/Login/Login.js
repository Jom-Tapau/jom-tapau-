...
const Login = () => {
  ...
  const [sendPasswordResetEmail, sending, PassswordResetError] =
  ...
  return (
    ...
    >
        ...
        <div className="w-75 mx-auto px-lg-5 mt-4">
          ...
          <form className="w-100 " onSubmit={handleLoginForm}>
            ...
            <p className="text-danger">
              {error ||
                (fbError && fbError.message.split("/")[1].split(")")[0]) || PassswordResetError&&PassswordResetError.message.split("/")[1].split(")")[0]}
            </p>
      ...
      {
        sent && <ToastContainer className="p-3" position="bottom-end">
        <Toast bg="danger" onClose={()=>setSent(false)}>
            <Toast.Header>
              <img
                ...
                alt=""
              />
              <strong className="me-auto">Jom Tapau</strong>
              <small className="text-muted">just now</small>
            </Toast.Header>
            <Toast.Body style={{color:"white"}}>Password reset link has been sent</Toast.Body>
          </Toast>
          </ToastContainer>
      }
    </div>
